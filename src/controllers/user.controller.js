...
const coverImageLocalPath = coverImageFile?.path || "";
    ...
    //inside aggreagate mongoose does not work directly thus if req.user._id this will give a string and not an object id which will create an error and we need to convert it to object id
    const getWatchHistory= asyncHandler(async(rea, res)=>{
